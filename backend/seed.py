"""
Seed all portfolio data into MongoDB.
...
async def seed():
    if not MONGODB_URI:
        print("ERROR: Set MONGODB_URI in .env first.")
        return
    ...
    await db.experience.insert_many([
        {
            "company": "EMB Global",
    ...
    await db.projects.insert_many([
        ...
        },
        {
            ...
            "description": "Multi-portal B2B recruitment SaaS connecting employers, recruiters, and vendor agencies through 3 dedicated dashboards.",
            "bullets": [
                "Client Portal: Full requirement management with custom templates, JD upload with AI extraction, and EMBTalent chatbot.",
                "Admin Dashboard: 19-state candidate lifecycle, vendor vetting & approval, contract management.",
                "Vendor Portal: Multi-step onboarding, bench profile management, receiving requirements from admin.",
            ],
            "image_url": "",
            "live_url": "", "github_url": "",
        ...
        },
        {
            ...
            "bullets": [
                ...
                "Personalized learning paths with 25+ professional instructors.",
                "Flexible subscription plans with progress tracking.",
            ],
            "image_url": "",
        ...
        },
        {
            ...
            "bullets": [
                "AI-powered KickBot chatbot (Gemini 2.0 Flash + Groq fallback) with English + Hinglish support.",
                "Comprehensive admin panel: products, orders, users, reviews, blogs, banners, sellers, chat leads.",
                "OTP-based customer auth + separate admin auth, multi-filter browsing, wishlist, order tracking.",
        ...
        },
        {
            ...
            "bullets": [
                "Guided photo capture with SVG ghost overlays for 8 angles.",
                "12 analysis categories with 50+ checkpoints including stitching density, logo proportions, sole patterns.",
                "Freemium model: 3 free checks/day without login, email OTP auth, 8 major brands supported.",
                "Background async processing with frontend polling and per-check confidence scores.",
            ],
            "image_url": "",
    ...
    await db.skills.insert_many([
        ...
        },
        {
            ...
            "items": [
                ...
                {"name": "Conversational AI", "proficiency": 85}, {"name": "Prompt Engineering", "proficiency": 85},
                {"name": "Google Gemini", "proficiency": 85}, {"name": "Claude API", "proficiency": 80},
        ...
        },
        {
            ...
            "items": [
                ...
                {"name": "MongoDB", "proficiency": 85}, {"name": "PostgreSQL", "proficiency": 70},
                {"name": "RESTful APIs", "proficiency": 90}, {"name": "JWT Authentication", "proficiency": 85},
                {"name": "Git", "proficiency": 90}, {"name": "Vercel", "proficiency": 90},
                {"name": "Render", "proficiency": 80}, {"name": "Cloudinary", "proficiency": 80},
            ],
        ...
        },
        {
            ...
            "items": [
                ...
                {"name": "SEO Optimization", "proficiency": 85}, {"name": "Core Web Vitals", "proficiency": 85},
                {"name": "Agile/Scrum", "proficiency": 85}, {"name": "CI/CD", "proficiency": 80},
    ...
    client.close()
    print(f"\nSeed complete. Admin → {ADMIN_USERNAME} / {ADMIN_PASSWORD}")
